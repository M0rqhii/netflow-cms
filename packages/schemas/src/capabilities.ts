...
export type CapabilityDefinition = {
  ...
  canBePolicyControlled?: boolean; // Can be toggled via org policy
...
export const CAPABILITY_REGISTRY: CapabilityDefinition[] = [
  ...
  // ============================================
  {
    ...
    description: 'View global platform overview and administrative dashboard',
    riskLevel: 'LOW',
    isDangerous: false,
  ...
  },
  {
    ...
    description: 'View organizations across the entire platform',
    riskLevel: 'LOW',
    isDangerous: false,
    defaultPolicyEnabled: true,
  },
  {
    ...
    description: 'Create, update, suspend, and remove organizations platform-wide',
    riskLevel: 'HIGH',
    isDangerous: true,
    defaultPolicyEnabled: true,
  },
  {
    ...
    module: 'platform',
    label: 'View Platform Users',
    description: 'View users across the entire platform',
    riskLevel: 'LOW',
    isDangerous: false,
    defaultPolicyEnabled: true,
  },
  {
    ...
    description: 'Invite, update, suspend, and remove platform users',
    riskLevel: 'HIGH',
    isDangerous: true,
    defaultPolicyEnabled: true,
  },
  {
    ...
    description: 'View global platform roles and assignments',
    riskLevel: 'LOW',
    isDangerous: false,
    defaultPolicyEnabled: true,
  },
  {
    ...
    description: 'Manage global platform role assignments and privileged access',
    riskLevel: 'HIGH',
    isDangerous: true,
    defaultPolicyEnabled: true,
  ...
  },
  {
    ...
    description: 'View plans, invoices, and subscription status across organizations',
    riskLevel: 'LOW',
    isDangerous: false,
    defaultPolicyEnabled: true,
  },
  {
    ...
    description: 'Change plans, manage payments, and perform billing operations platform-wide',
    riskLevel: 'HIGH',
    isDangerous: true,
    defaultPolicyEnabled: true,
    blockedForCustomRoles: true,
  },
  {
    ...
    description: 'View global audit events and privileged actions',
    riskLevel: 'MED',
    isDangerous: false,
    defaultPolicyEnabled: true,
  },
  ...
  },
  {
    ...
    description: 'Open support sessions and impersonate users with audit logging',
    riskLevel: 'HIGH',
    isDangerous: true,
    defaultPolicyEnabled: true,
  },
  {
    key: 'platform.dev.tools.access',
    module: 'platform',
    label: 'Access Developer Tools',
    description: 'Access developer-only platform tools and internal debugging screens',
    riskLevel: 'MED',
    isDangerous: false,
    defaultPolicyEnabled: true,
  },
  {
    key: 'platform.dev.logs.view',
    module: 'platform',
    label: 'View Platform Logs',
    description: 'View runtime logs, diagnostics, and integration traces',
    riskLevel: 'LOW',
    isDangerous: false,
    defaultPolicyEnabled: true,
  },
  {
    key: 'platform.dev.jobs.manage',
    module: 'platform',
    label: 'Manage Platform Jobs',
    description: 'Retry jobs, replay webhooks, and run maintenance operations',
    riskLevel: 'HIGH',
    isDangerous: true,
    defaultPolicyEnabled: true,
  },
  ...
  },
  {
    ...
    isDangerous: true,
    defaultPolicyEnabled: true,
    canBePolicyControlled: true, // Policy toggle
  },
  {
...
export function getBlockedCapabilities(): string[] {
  return CAPABILITY_REGISTRY.filter(cap => cap.blockedForCustomRoles).map(cap => cap.key);
}
